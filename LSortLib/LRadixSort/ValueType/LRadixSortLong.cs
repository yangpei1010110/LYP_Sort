...
{
    public class LRadixSortLong : LRadixSort<long, long>
    {
        ...
        private void RadixSortSequential(byte byteIndex, long[] source, long[] dest, int length)
        {
            ...
            {
                byte index = (byte)((LongToULong(source[i]) >> byteOffset) & 0xFF);
                countArr[index] += 1;
            }
